        ...
        <div class="content col-xs-9">
          <ul class="form-set">
            ...
            <li class="form-group row">
              ...
              <div class="col-xs-9">
                <textarea class="form-control" rows="5" id="website-keywords" name="website_keywords"><?php echo $general['website_keywords'];?></textarea class="form-control">  
            ...
            <li class="form-group row">
              ...
              <div class="col-xs-9">
                <div class="color-thumb edit" id="picture" onclick="openBrowser()" style="width: 40px; height: 40px">
                   <img class="" id="upload-image" width="40px;" src="<?php echo $prefix_url.$general['logo'];?>">
                </div>
        ...
        <div class="content col-xs-9">
          <ul class="form-set">
            <li class="form-group row">
              ...
              <div class="col-xs-9">
                <input type="text" class="form-control" id="google" name="google_analytics" value="<?php echo $general['analytics_code'];?>" placeholder="example: UA-40171222-1">
              </div>
            </li>
          </ul>
        </div>
