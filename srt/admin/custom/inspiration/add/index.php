...
<form method="post" enctype="multipart/form-data">
            ...
            <div class="subnav">
              <div class="container clearfix">
                <h1><span class="glyphicon glyphicon-list"></span> &nbsp; Add Page Banner</h1>
                    ...
                    <li class="form-group row">
                      ...
                      <div class="content col-xs-9">
                        <select class="form-control" name="inspiration_category" id="id_inspiration_category">
                          <option value="1" <?php if($cat_one['rows'] > 0){ echo 'disabled="disabled"';}?>>HOME</option>
                          <option value="2"<?php if($cat_two['rows'] > 0){ echo 'disabled="disabled"';}?>>SERVICES</option>
                          <option value="6"<?php if($cat_six['rows'] > 0){ echo 'disabled="disabled"';}?>>-- SERVICES - Body</option>
                          <option value="3"<?php if($cat_three['rows'] > 0){ echo 'disabled="disabled"';}?>>COMPANY</option>
                          <option value="7"<?php if($cat_seven['rows'] > 0){ echo 'disabled="disabled"';}?>>-- COMPANY - Body</option>
                          <option value="4"<?php if($cat_four['rows'] > 0){ echo 'disabled="disabled"';}?>>LOCATIONS</option>
                          <option value="5"<?php if($cat_five['rows'] > 0){ echo 'disabled="disabled"';}?>>CONTACT</option>
                        </select>
                      </div>
                    </li>
                    
                    <li class="form-group row" id="lbl_inspiration_name">
                      <label for="brand" class="control-label col-xs-3">Banner Heading <span>*</span></label>
                      <div class="content col-xs-9">
