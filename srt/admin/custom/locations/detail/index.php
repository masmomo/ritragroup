            ...
            <div class="subnav">
              <div class="container clearfix">
                <h1>
                  ...
                  <a href="<?php echo $prefix_url."location"?>">Location</a> 
                  <span class="info">/</span> Edit Location
                </h1>
                
                <div class="btn-placeholder">
                  <a href="<?php echo $prefix_url."location"?>">
                  ...
                  <input type="submit" class="btn btn-success btn-sm hidden" value="Save Changes" name="btn_edit_location" id="id_btn_save">
                  <input type="submit" class="btn btn-success btn-sm hidden" value="Save Changes &amp; Exit" name="btn_edit_location" id="id_btn_exit">
                </div>
              </div>
            </div>
                ...
                <div class="content col-xs-9">
                  <ul class="form-set">
                    <li class="form-group row hidden">
                      <label for="brand" class="control-label col-xs-3">Page <span>*</span></label>
                      <div class="content col-xs-9">
                    ...
                    <li class="form-group row" id="lbl_inspiration_name">
                      <label for="brand" class="control-label col-xs-3">Location Name <span>*</span></label>
                      <div class="content col-xs-9">
                    ...
                    <li class="form-group row" id="lbl_inspiration_name">
                      <label for="brand" class="control-label col-xs-3">Location Address <span>*</span></label>
                      <div class="content col-xs-9">
                        <textarea class="form-control" name="inspiration_description" id="id_inspiration_description" rows="7"><?php echo $inspiration['description'];?></textarea>
                      </div>
                    </li>
                    
                    <li class="form-group row" id="lbl_inspiration_name">
                      <label for="brand" class="control-label col-xs-3">Longitude <span>*</span></label>
                      <div class="content col-xs-3">
                        <input type="text" class="form-control" name="inspiration_description_long" id="id_inspiration_description_1" value="<?php echo str_replace('/','', $longitude);?>">
                      </div>
                      <label for="brand" class="control-label col-xs-2">Lattitude <span>*</span></label>
                      <div class="content col-xs-3">
                        <input type="text" class="form-control" name="inspiration_description_latt" id="id_inspiration_description_2" value="<?php echo $latitude;?>">
                      </div>
                    </li>
                  </ul>
                </div>
