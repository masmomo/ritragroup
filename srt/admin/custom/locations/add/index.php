            ...
            <div class="subnav">
              <div class="container clearfix">
                ...
                <div class="btn-placeholder">
                  ...
                  <input type="submit" class="btn btn-success btn-sm hidden" value="Save Changes" name="btn_add_location" id="id_btn_save">
                  <input type="submit" class="btn btn-success btn-sm hidden" value="Save Changes &amp; Exit" name="btn_add_location" id="id_btn_exit">
                </div>
              </div>
            </div>
                ...
                <div class="content col-xs-9">
                  <ul class="form-set">
                    ...
                    <li class="form-group row" id="lbl_inspiration_name">
                      ...
                      <div class="content col-xs-9">
                        <textarea class="form-control" name="inspiration_description" id="id_inspiration_description"></textarea>
                      </div>
                    </li>
                    
                    <li class="form-group row" id="lbl_inspiration_name">
                      <label for="brand" class="control-label col-xs-3">Lattitude <span>*</span></label>
                      <div class="content col-xs-3">
                        <input type="text" class="form-control" name="inspiration_description_latt" id="id_inspiration_description_2">
                      </div>
                      <label for="brand" class="control-label col-xs-2">Longitude <span>*</span></label>
                      <div class="content col-xs-3">
                        <input type="text" class="form-control" name="inspiration_description_long" id="id_inspiration_description_1">
                      </div>
                    </li>
                  </ul>
                </div>
