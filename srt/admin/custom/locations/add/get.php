...
function count_inspiration_image(){
   ...
   $sql    = "SELECT COUNT(*) AS rows FROM tbl_location_imgae";
   $query  = mysql_query($sql, $conn);
...
function count_inspiration($category){
   $conn   = connDB();
   
   $sql    = "SELECT COUNT(*) AS rows FROM tbl_location WHERE `category` = '$category'";
   $query  = mysql_query($sql, $conn);
   $result = mysql_fetch_array($query);
...
function get_inspiration_latest_id(){
   ...
   $sql    = "SELECT MAX(inspiration_id) AS latest_inspiration_id FROM tbl_location";
   $query  = mysql_query($sql, $conn);
   $result = mysql_fetch_array($query);
