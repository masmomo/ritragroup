          ...
          <form name="index-order" method="post" enctype="multipart/form-data">
            ...
            <div class="subnav">
              <div class="container clearfix">
                <h1><span class="glyphicon glyphicon-list"></span> &nbsp; Manage Locations</h1>
                ...
                <div class="btn-placeholder">
                  <a href="<?php echo $prefix_url."add-location";?>">
            ...
            <div class="container main">
                <div class="box row">
                  ...
                  <div class="pull-right">
                    ...
                    <input type="submit" class="btn btn-success pull-left" value="GO" name="btn_index_location">
                  </div>
                </div><!--actions-->
                ...
                <table cellpadding="0" cellspacing="0" class="table">
                  ...
                  <tbody onload="loading()">
                    ...
                    <tr id="<?php echo "row_".$row?>" onclick="selectRow('<?php echo $row;?>')">
                      ...
                      <td width="652">
                        <a href="<?php echo $prefix_url."location-detail/".$inspiration['inspiration_id'];?>">
