...
function update_inspirations($post_visibility, $post_inspiration_id){
   ...
   $sql   = "UPDATE tbl_location SET `inspiration_visibility` = '$post_visibility' WHERE `inspiration_id` = '$post_inspiration_id'";
   $query = mysql_query($sql, $conn) or die(mysql_error());
}
...
function delete_inspiration($post_inspiration_id){
   ...
   $sql   = "DELETE FROM tbl_location WHERE `inspiration_id` = '$post_inspiration_id'";
   $query = mysql_query($sql, $conn) or die(mysql_error());
}
...
function edit_inspiration_image($post_param_inspiration_id, $post_image, $post_active, $post_visibility, $post_inspiration_image_id){
   ...
   $sql   = "UPDATE tbl_location_image SET `param_inspiration_id` = '$post_param_inspiration_id',
                                           `image` = '$post_image',
										   `active` = '$post_active',
										   `visibility` = '$post_visibility'
...
function delete_inspiration_image($post_inspiration_id){
   ...
   $sql   = "DELETE FROM tbl_location_image WHERE `param_inspiration_id` = '$post_inspiration_id'";
   $query = mysql_query($sql, $conn) or die(mysql_error());
}
...
function edit_inspiration_featured($post_param_inspiration_id, $post_product_type_id, $post_active, $post_visibility, $post_inspiration_featured_id){
   ...
   $sql   = "UPDATE tbl_location_featured SET `param_inspiration_id` = '$post_param_inspiration_id',
...
function delete_inspiration_featured($post_inspiration_id){
   ...
   $sql   = "DELETE FROM tbl_location_featured WHERE `param_inspiration_id` = '$post_inspiration_id'";
   $query = mysql_query($sql, $conn) or die(mysql_error());
}
?>